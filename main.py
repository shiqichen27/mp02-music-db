...
def show_playlist_tracks(conn):
    ...
    rows = get_playlist_tracks(conn, playlist_name) # replace with: get_playlist_tracks(conn, playlist_name)
    if not rows:
...
def show_most_added_track(conn):
    ...
    result = get_most_added_track(conn) # replace with: get_most_added_track(conn)
...
def show_playlist_durations(conn):
    ...
    rows = get_playlist_durations(conn) # replace with: get_playlist_durations(conn)
    if not rows:
